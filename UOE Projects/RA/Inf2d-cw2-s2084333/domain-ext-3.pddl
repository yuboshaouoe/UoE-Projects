(define (domain warehouse-ext-3)
    ...
    (:functions
        ...
        (PackageType ?p - object)
        (LargePackageType ?p - object)
        (BeltType ?b - belt)
    )
    ...
    (:action MBDELIVERTYPE1
        :parameters (?c - cell ?m - object ?p - object ?b - belt ?s - switch)
        :precondition (and (MailBot ?m) (Package ?p) (DeliveryBelt ?b) (= (BeltType ?b) 1) (= (PackageType ?p) 1) (ObjectHeld ?m ?p) (Scanned ?p) (On ?m ?c) (NextToBelt1 ?c) (TurnedOn ?s))
        :effect (and (not (ObjectHeld ?m ?p)) (not (IsHolding ?m)) (Delivered ?p))
    )

    (:action DBDELIVERTYPE1
        :parameters (?c - cell ?d - object ?p - object ?b - belt ?s - switch)
        :precondition (and (DeliveryBot ?d) (Package ?p) (DeliveryBelt ?b) (= (BeltType ?b) 1) (= (PackageType ?p) 1) (ObjectHeld ?d ?p) (Scanned ?p) (On ?d ?c) (NextToBelt1 ?c) (TurnedOn ?s))
        :effect (and (not (ObjectHeld ?d ?p)) (not (IsHolding ?d)) (Delivered ?p))
    )

    (:action MBDELIVERTYPE2
        :parameters (?c - cell ?m - object ?p - object ?b - belt ?s - switch)
        :precondition (and (MailBot ?m) (Package ?p) (DeliveryBelt ?b) (= (BeltType ?b) 2) (= (PackageType ?p) 2) (ObjectHeld ?m ?p) (Scanned ?p) (On ?m ?c) (NextToBelt2 ?c) (TurnedOn ?s))
        :effect (and (not (ObjectHeld ?m ?p)) (not (IsHolding ?m)) (Delivered ?p))
    )

    (:action DBDELIVERTYPE2
        :parameters (?c - cell ?d - object ?p - object ?b - belt ?s - switch)
        :precondition (and (DeliveryBot ?d) (Package ?p) (DeliveryBelt ?b) (= (BeltType ?b) 2) (= (PackageType ?p) 2) (ObjectHeld ?d ?p) (Scanned ?p) (On ?d ?c) (NextToBelt2 ?c) (TurnedOn ?s))
        :effect (and (not (ObjectHeld ?d ?p)) (not (IsHolding ?d)) (Delivered ?p))
    )
